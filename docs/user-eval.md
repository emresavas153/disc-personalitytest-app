...
Ziel der Evaluation ist es zu prüfen, wie verständlich, intuitiv und sinnvoll die Anwendung von Erstnutzern wahrgenommen wird. Im Fokus stehen Bedienbarkeit, Klarheit der Fragen, Designverständnis und das Vertrauen in das Ergebnis.

### Method

Für die Evaluation wurden Usability‑Tests mit 8 Testpersonen durchgeführt. Die Teilnehmenden führten unter Beobachtung den vollständigen DISC‑Test als Teilnehmer durch, erstellten einen neuen Host Account und einen neuen Workshop, welchen sie verwalten sollten. Sie nutzten dabei die Thinking‑Aloud‑Methode, bei der sie ihre Gedanken, Zweifel und Entscheidungen während der Nutzung laut beschrieben. Der Ablauf wurde protokolliert, inklusive Bearbeitungszeit, Klickverhalten, Rücksprünge, Pausen und Stellen mit sichtbarer Unsicherheit. Zusätzlich wurden zentrale Aussagen und Kommentare der Teilnehmenden festgehalten, um ein tieferes Verständnis der Nutzerwahrnehmung zu erhalten.
...
### Implications
Die Evaluation zeigt insgesamt ein sehr positives Bild: Die zentralen Abläufe werden schnell verstanden und die Anwendung wirkt für Erstnutzer nachvollziehbar. Besonders hervorzuheben ist, dass die Teilnehmenden den Testablauf als logisch und die Ergebnisse als grundsätzlich hilfreich beschrieben haben. Die klare Struktur der Schritte unterstützt eine zügige Durchführung und vermittelt Vertrauen in das Ergebnis.
...
+ Intuitive Workshop-Erstellung
+ Niedrige Einstiegshürde für Hosts

Insgesamt bestätigt die Evaluation, dass die Anwendung funktional und strukturell gut aufgestellt ist. Die wichtigsten Ableitungen betreffen nicht die grundlegende Bedienbarkeit, sondern die Vertiefung der Ergebnisinterpretation und die visuelle Klarheit bestimmter Inhalte.

Mit gezielten Ergänzungen in diesen Bereichen kann nicht nur die Nutzerzufriedenheit weiter gesteigert werden, sondern auch das Vertrauen in die Aussagekraft des Tests nachhaltig gestärkt werden.
